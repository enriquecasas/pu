	...
	<div class="side-navbar-wrapper">
		...
		<div class="main-menu">
			...
			<ul id="side-main-menu" class="side-menu list-unstyled">
				<li><a href="pu/main/bienvenido"><i
			...
			<div
				...
				<div class="navbar-header">
					<a id="toggle-btn" href="#" class="menu-btn"><i
						class="icon-bars"> </i></a><a href="/sprintemplate/main/bienvenido">
						<div class="brand-text d-none d-md-inline-block">
							<strong class="text-primary"> Principal</strong>
						</div>
					</a>
				</div>
				<ul
					...
					<!-- Languages dropdown    -->
					<!-- Log out-->
					<li class="nav-item"><a href="/sprintemplate/"
