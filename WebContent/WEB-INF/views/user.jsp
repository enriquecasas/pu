						...
						<tbody>
							<c:forEach items="${lista}" var="user">
								...
								<tr>
									...
									<td>${user.clave}</td>
									<td>${user.estado}</td>
									<td><a href="upd/${user.idusuario}" style="color: blue;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
									<td><a href="del/${user.idusuario}" style="color: red;"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
